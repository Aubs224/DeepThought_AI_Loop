...
def generate_questions(count: int, domains: list[str], model: str) -> dict[str, Any]:
    prompt = USER_PROMPT_TEMPLATE.format(count=count, domains=", ".join(domains))
...
def main() -> None:
    ...
    result = generate_questions(args.count, args.domains, args.model)
